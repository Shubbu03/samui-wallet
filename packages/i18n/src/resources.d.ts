...
interface Resources {
  ...
  portfolio: {
    ...
    sendNoSignableAccounts: 'No signable accounts available'
    sendNoSignableAccountsDescription: 'You need a derived or imported account to send transactions.'
    sendSelectAccountDescription: 'Watch-only accounts cannot sign transactions. Select an account that can sign.'
    sendSelectAccountPlaceholder: 'Select account...'
    sendSelectAccountTitle: 'Select a signing account'
  }
  settings: {
